...
export default function WelcomeState({ heading, description }) {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-20">
      ...
      <h3 className="text-3xl font-black text-gray-900">{heading}</h3>
      <p className="text-gray-500 mt-4 max-w-md mx-auto text-lg">{description}</p>
    </div>
  );
}
